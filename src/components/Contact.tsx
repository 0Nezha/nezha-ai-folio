...
import { toast } from "sonner"; // ✅ utilise uniquement sonner
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mrbloggq', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        toast.success("Message Sent! Thank you for reaching out. I'll get back to you soon.",
          { position: "top-center" , // ✅ affichage en haut
            style: {
              backgroundColor:  "#1db957ff",
              color: "white",  
           }
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="scroll-reveal bg-card rounded-xl p-8 ">
            ...
            <div className="scroll-reveal space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">nezhaaitelhad@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Within 12/24 hours</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-xl p-8 card-shadow">
                ...
                <div className="flex space-x-4">
                  <a  href="https://www.linkedin.com/in/nezha-ait-el-had-9a4503273" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon" className="hover:bg-primary hover:text-primary-foreground transition-spring">
                  ...
                  <a  href="https://github.com/0Nezha" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon" className="hover:bg-primary hover:text-primary-foreground transition-spring">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
